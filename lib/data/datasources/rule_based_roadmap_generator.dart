...
class RuleBasedRoadmapGenerator implements RoadmapGenerator {
  ...
  Future<PersonalizedRoadmap> recalculateRoadmap({
    ...
    return _buildRoadmap(
        profile: updatedProfile, existingRoadmap: currentRoadmap);
  }
    ...
    final resolvedPhases = phases.map((phase) {
      final updatedItems = phase.items.map((item) {
        ...
        final hasUnmetPrereq = item.prerequisites
            .any((prereqId) => !allCompletedIds.contains(prereqId));
        if (hasUnmetPrereq) {
  ...
  List<RoadmapPhase> _generateTrackPhases(
    ...
    final isAi = career.contains('ai') ||
        career.contains('machine learning') ||
        career.contains('data scientist');
    final isWeb = career.contains('web') ||
        career.contains('frontend') ||
        career.contains('full stack');
    ...
    final isPlacement = profile.goals.contains('Placement') ||
        profile.goals.contains('Internship');
    final isHigherEd = profile.goals.contains('Higher Studies') ||
        profile.goals.contains('Competitive Exams');
  ...
  List<RoadmapPhase> _buildAiTrack(
      PersonalizedProfile profile, Map<String, bool> completed) {
    final lang =
        profile.primaryLanguage.isNotEmpty ? profile.primaryLanguage : 'Python';
    final isWeakMath =
        profile.weaknesses.any((w) => w.toLowerCase().contains('math'));
    final isWeakDsa =
        profile.weaknesses.any((w) => w.toLowerCase().contains('dsa'));
    ...
    final p1Items = <RoadmapItem>[
      _createItem(
        ...
        description:
            'Control structures, object-oriented concepts, and functional patterns in $lang.',
        ...
        recommendationReason:
            'Core foundation language required for data handling & ML algorithms.',
        completed: completed,
      ),
      _createItem(
        id: 'ai_p1_math',
        ...
        description:
            'Linear algebra, matrix calculus, probability distributions, and hypothesis testing.',
        category: 'Mathematics',
        difficulty: isWeakMath
            ? RoadmapDifficulty.beginner
            : RoadmapDifficulty.intermediate,
        estimatedMinutes: 45,
        priority: isWeakMath
            ? RoadmapItemPriority.critical
      ...
      _createItem(
        ...
        description:
            'Arrays, hash maps, binary trees, recursion, and Big-O efficiency.',
        category: 'DSA',
        difficulty: RoadmapDifficulty.intermediate,
        estimatedMinutes: 45,
        priority:
            isWeakDsa ? RoadmapItemPriority.critical : RoadmapItemPriority.high,
    ...
    final p2Items = <RoadmapItem>[
      _createItem(
        ...
        description:
            'Vectorized operations, dataframe cleaning, feature filtering, and aggregations.',
        ...
        recommendationReason:
            'NumPy & Pandas are standard prerequisites for data manipulation in AI.',
        completed: completed,
      ),
      _createItem(
        id: 'ai_p2_ml',
        ...
        description:
            'Regression, Decision Trees, Random Forests, SVMs, Clustering with Scikit-learn.',
        ...
        hintId: 'ai_machine_learning',
        recommendationReason:
            'Core discipline for your target AI Engineer career track.',
        completed: completed,
      ),
    ];
    ...
    final p3Items = <RoadmapItem>[
      _createItem(
        ...
        description:
            'Feedforward networks, backpropagation, CNNs, RNNs, and PyTorch / TensorFlow.',
        ...
        recommendationReason:
            'Prerequisite for Computer Vision, NLP, and modern LLM architectures.',
        completed: completed,
      ),
      _createItem(
        id: 'ai_p3_genai',
        ...
        description:
            'Transformers, embeddings, RAG pipelines, LangChain, and AI Agent workflows.',
        ...
        hintId: 'ai_nlp',
        recommendationReason:
            'High-demand industry competency for modern AI engineering roles.',
        completed: completed,
      ),
    ];
    ...
    final p4Items = <RoadmapItem>[
      _createItem(
        ...
        description:
            'Develop and deploy an AI/ML web application with FastAPI, Docker, and Streamlit.',
        category: 'Project',
        difficulty: RoadmapDifficulty.advanced,
        estimatedMinutes: 90,
        priority: RoadmapItemPriority.critical,
        ...
        recommendationReason:
            'Tangible proof-of-work project necessary for technical resumes and interviews.',
        completed: completed,
      ),
      _createItem(
        id: 'ai_p4_quiz',
        ...
        description:
            'Timed quantitative aptitude, logic drills, and CS mock test simulations in UniDocs.',
        category: 'Placement',
        difficulty: RoadmapDifficulty.intermediate,
        estimatedMinutes: 45,
        priority: RoadmapItemPriority.high,
        ...
        recommendationReason:
            'Sharpens problem-solving speed and interview readiness.',
        completed: completed,
      ),
    ];
    ...
    return [
      RoadmapPhase(
        ...
        description:
            'Master $lang fundamentals, essential mathematics, and algorithm complexity.',
        sequence: 1,
      ...
      RoadmapPhase(
        ...
        description:
            'Data transformation with Pandas and standard algorithms with Scikit-learn.',
        sequence: 2,
      ...
      RoadmapPhase(
        ...
        description:
            'Neural networks, Transformers, embeddings, and intelligent agent workflows.',
        sequence: 3,
      ...
      RoadmapPhase(
        ...
        description:
            'Deploy production AI systems and practice technical assessments.',
        sequence: 4,
        estimatedDuration: '3–4 weeks',
        items: p4Items,
      ),
  ...
  List<RoadmapPhase> _buildWebTrack(
      PersonalizedProfile profile, Map<String, bool> completed) {
    final p1Items = <RoadmapItem>[
      _createItem(
        id: 'web_p1_html',
        ...
        description:
            'Flexbox, CSS Grid, responsive design, and accessible DOM structures.',
        category: 'Frontend',
        difficulty: RoadmapDifficulty.beginner,
        estimatedMinutes: 45,
        priority: RoadmapItemPriority.critical,
        ...
        hintId: 'web_html_css',
        recommendationReason:
            'Core building block for all browser-based interfaces.',
        completed: completed,
      ),
      _createItem(
        id: 'web_p1_js',
        ...
        description:
            'Closures, promises, async/await, fetch API, and event loop mechanics.',
        category: 'Programming',
        difficulty: RoadmapDifficulty.beginner,
        estimatedMinutes: 45,
        priority: RoadmapItemPriority.critical,
        ...
        recommendationReason:
            'Mandatory programming foundation for React and backend Node.js.',
        completed: completed,
      ),
    ];
    ...
    final p2Items = <RoadmapItem>[
      _createItem(
        ...
        description:
            'Component lifecycles, useState, useEffect, context API, and modular UI patterns.',
        category: 'Frontend',
        difficulty: RoadmapDifficulty.intermediate,
        estimatedMinutes: 60,
        priority: RoadmapItemPriority.critical,
        ...
        hintId: 'web_react',
        recommendationReason:
            'Most widely adopted frontend framework in modern web software engineering.',
        completed: completed,
      ),
      _createItem(
        id: 'web_p2_dsa',
        ...
        description:
            'State graph traversals, JSON manipulation, and efficient lookup algorithms.',
        category: 'DSA',
        difficulty: RoadmapDifficulty.intermediate,
        estimatedMinutes: 45,
        priority: RoadmapItemPriority.high,
    ...
    final p3Items = <RoadmapItem>[
      _createItem(
        ...
        description:
            'Express.js, authentication (JWT), request routing, and middleware patterns.',
        category: 'Backend',
        difficulty: RoadmapDifficulty.intermediate,
        estimatedMinutes: 60,
        priority: RoadmapItemPriority.critical,
        ...
        recommendationReason:
            'Connects frontend clients with reliable server-side business logic.',
        completed: completed,
      ),
      _createItem(
        id: 'web_p3_db',
        ...
        description:
            'Schema design, normalization, indexing, queries, and ORM integration.',
        category: 'Databases',
        difficulty: RoadmapDifficulty.intermediate,
        estimatedMinutes: 45,
        priority: RoadmapItemPriority.critical,
        ...
        hintId: 'db_sql',
        recommendationReason:
            'Essential database persistence required for all full stack web apps.',
        completed: completed,
      ),
    ];
    ...
    final p4Items = <RoadmapItem>[
      _createItem(
        ...
        description:
            'Build and deploy a complete web application with auth, database, and cloud hosting.',
        category: 'Project',
        difficulty: RoadmapDifficulty.advanced,
        estimatedMinutes: 90,
        priority: RoadmapItemPriority.critical,
        ...
        recommendationReason:
            'Serves as the flagship portfolio project during interviews.',
        completed: completed,
      ),
    ];
    ...
    return [
      RoadmapPhase(
        ...
        description:
            'Master HTML5 semantic markup, CSS layouts, and modern ES6+ programming.',
        sequence: 1,
        estimatedDuration: '3–4 weeks',
        items: p1Items,
      ),
      RoadmapPhase(
        ...
        description:
            'Build interactive, responsive single-page applications with reusable components.',
        sequence: 2,
        estimatedDuration: '4–5 weeks',
        items: p2Items,
      ),
      RoadmapPhase(
        ...
        description:
            'Design RESTful APIs, manage databases, and implement secure auth.',
        sequence: 3,
        estimatedDuration: '4–5 weeks',
        items: p3Items,
      ),
      RoadmapPhase(
        ...
        description:
            'Deploy production systems and prepare for software engineering interviews.',
        sequence: 4,
        estimatedDuration: '3–4 weeks',
        items: p4Items,
      ),
  ...
  List<RoadmapPhase> _buildCybersecurityTrack(
      PersonalizedProfile profile, Map<String, bool> completed) {
    return [
      RoadmapPhase(
        ...
        description:
            'Master TCP/IP, OSI layers, DNS, subnetting, and Linux CLI shell scripting.',
        sequence: 1,
        ...
        items: [
          _createItem(
            ...
            description:
                'Packets, routing, Wireshark packet analysis, TCP handshakes, and firewalls.',
            category: 'Networking',
            difficulty: RoadmapDifficulty.beginner,
            estimatedMinutes: 45,
            priority: RoadmapItemPriority.critical,
            ...
            hintId: 'cyber_intro',
            recommendationReason:
                'Core prerequisite for all defensive and offensive security concepts.',
            completed: completed,
          ),
          _createItem(
            id: 'sec_p1_linux',
            ...
            description:
                'File permissions, process management, bash scripting, and system security.',
            ...
            hintId: 'basics_intro',
            recommendationReason:
                'Standard operating system environment for cybersecurity tools.',
            completed: completed,
          ),
        ],
      ),
      RoadmapPhase(
        ...
        description:
            'Cryptography, web vulnerability scanning (OWASP Top 10), and pen-testing tools.',
        sequence: 2,
        ...
        items: [
          _createItem(
            ...
            description:
                'SQL Injection, XSS, CSRF, authentication bypass, and security headers.',
            category: 'Security',
            difficulty: RoadmapDifficulty.intermediate,
            estimatedMinutes: 60,
            priority: RoadmapItemPriority.critical,
            ...
            hintId: 'cyber_intro',
            recommendationReason:
                'Core industry standard for securing web applications.',
            completed: completed,
          ),
        ],
      ),
      RoadmapPhase(
        ...
        description:
            'Threat hunting, log analysis, and incident response exercises.',
        sequence: 3,
        estimatedDuration: '4 weeks',
        items: [
          _createItem(
            ...
            description:
                'Configure security monitoring, analyze malicious traffic, and write reports.',
            category: 'Project',
            difficulty: RoadmapDifficulty.advanced,
            estimatedMinutes: 90,
            priority: RoadmapItemPriority.high,
            ...
            hintId: 'portfolio_website_proj',
            recommendationReason:
                'Practical hands-on lab demonstration needed for cybersecurity roles.',
            completed: completed,
          ),
        ],
      ),
  ...
  List<RoadmapPhase> _buildCloudDevOpsTrack(
      PersonalizedProfile profile, Map<String, bool> completed) {
    return [
      RoadmapPhase(
        id: 'p1_devops_basics',
        ...
        description:
            'Version control workflows, SSH keys, CLI commands, and network fundamentals.',
        sequence: 1,
        estimatedDuration: '3–4 weeks',
        items: [
          _createItem(
            ...
            description:
                'Branching strategies, merge conflicts, pull requests, and automated actions.',
            category: 'Tools',
            difficulty: RoadmapDifficulty.beginner,
            estimatedMinutes: 45,
            priority: RoadmapItemPriority.critical,
            ...
            hintId: 'basics_intro',
            recommendationReason:
                'Foundational tool for infrastructure-as-code and release pipelines.',
            completed: completed,
          ),
        ],
      ),
      RoadmapPhase(
        ...
        description:
            'Containerizing services, Docker Compose, and AWS/GCP cloud services.',
        sequence: 2,
        estimatedDuration: '5 weeks',
        items: [
          _createItem(
            ...
            description:
                'Dockerfiles, multi-stage builds, container networking, and volume management.',
            category: 'Cloud',
            difficulty: RoadmapDifficulty.intermediate,
            estimatedMinutes: 60,
            priority: RoadmapItemPriority.critical,
            ...
            recommendationReason:
                'Standard container runtime essential for modern cloud deployments.',
            completed: completed,
          ),
        ],
      ),
      RoadmapPhase(
        ...
        description:
            'Pods, Deployments, Services, Helm charts, and continuous deployment.',
        sequence: 3,
        estimatedDuration: '4–5 weeks',
        items: [
          _createItem(
            ...
            description:
                'Deploy a multi-service web app to a cloud Kubernetes cluster with monitoring.',
            category: 'Project',
            difficulty: RoadmapDifficulty.advanced,
            estimatedMinutes: 90,
            priority: RoadmapItemPriority.critical,
            ...
            hintId: 'devops_docker',
            recommendationReason:
                'Demonstrates end-to-end cloud infrastructure proficiency.',
            completed: completed,
          ),
        ],
      ),
  ...
  List<RoadmapPhase> _buildHigherEdTrack(
      PersonalizedProfile profile, Map<String, bool> completed) {
    return [
      RoadmapPhase(
        id: 'p1_gate_core',
        ...
        description:
            'Calculus, linear algebra, graph theory, combinatorics, and probability.',
        sequence: 1,
        estimatedDuration: '4–6 weeks',
        items: [
          _createItem(
            ...
            description:
                'Automata theory, regular expressions, context-free grammars, and Turing machines.',
            ...
            hintId: 'gate_cse',
            recommendationReason:
                'High weightage subject in GATE CS and MS entrance examinations.',
            completed: completed,
          ),
        ],
      ),
      RoadmapPhase(
        ...
        description:
            'Memory hierarchy, SQL normalization, pipelining, and routing protocols.',
        sequence: 2,
        ...
        items: [
          _createItem(
            ...
            description:
                'Process scheduling, deadlocks, virtual memory, relational algebra, and ACID transactions.',
            category: 'Operating Systems',
            difficulty: RoadmapDifficulty.advanced,
            estimatedMinutes: 60,
            priority: RoadmapItemPriority.critical,
            ...
            hintId: 'db_sql',
            recommendationReason:
                'Essential theoretical pillars tested in competitive exams.',
            completed: completed,
          ),
        ],
      ),
  ...
  List<RoadmapPhase> _buildPlacementSprintTrack(
      PersonalizedProfile profile, Map<String, bool> completed) {
    final lang =
        profile.primaryLanguage.isNotEmpty ? profile.primaryLanguage : 'Java';
    ...
    return [
      RoadmapPhase(
        ...
        description:
            'Arrays, two pointers, sliding window, binary search, trees, and graphs in $lang.',
        sequence: 1,
        estimatedDuration: '4 weeks',
        items: [
          _createItem(
            ...
            description:
                'Master time complexity, arrays, strings, hash maps, and recursion patterns.',
            category: 'DSA',
            difficulty: RoadmapDifficulty.intermediate,
            estimatedMinutes: 45,
            priority: RoadmapItemPriority.critical,
            ...
            hintId: 'dsa_arrays',
            recommendationReason:
                'Primary filter in technical interview screening rounds.',
            completed: completed,
          ),
          _createItem(
            id: 'plc_p1_apt',
            ...
            description:
                'Speed math, percentages, ratios, syllogisms, and coding aptitude quizzes.',
            category: 'Placement',
            difficulty: RoadmapDifficulty.intermediate,
            estimatedMinutes: 30,
            priority: RoadmapItemPriority.critical,
            ...
            hintId: 'quant_aptitude',
            recommendationReason:
                'Essential first round qualification for campus placement drives.',
            completed: completed,
          ),
        ],
      ),
      RoadmapPhase(
        ...
        description:
            'OOP concepts, DBMS normalization, OS concurrency, and system design basics.',
        sequence: 2,
        estimatedDuration: '4 weeks',
        items: [
          _createItem(
            ...
            description:
                'Standard conceptual interview questions, SQL queries, and architecture diagrams.',
            ...
            recommendationReason:
                'Crucial for technical face-to-face interview clearing.',
            completed: completed,
          ),
          _createItem(
            id: 'plc_p2_mock',
            ...
            description:
                'Simulate real company placement rounds with automated scorecards.',
            category: 'Placement',
            difficulty: RoadmapDifficulty.intermediate,
            estimatedMinutes: 45,
            priority: RoadmapItemPriority.high,
            ...
            recommendationReason:
                'Builds test-taking stamina and reduces assessment anxiety.',
            completed: completed,
          ),
        ],
      ),
  ...
  List<RoadmapPhase> _buildSoftwareEngineeringTrack(
      PersonalizedProfile profile, Map<String, bool> completed) {
    final lang =
        profile.primaryLanguage.isNotEmpty ? profile.primaryLanguage : 'Java';
    ...
    return [
      RoadmapPhase(
        ...
        description:
            'Modular design, OOP principles, data structures, and debugging in $lang.',
        sequence: 1,
        estimatedDuration: '4 weeks',
        items: [
          _createItem(
            ...
            description:
                'Encapsulation, inheritance, polymorphism, design patterns, and unit tests.',
            category: 'Programming',
            difficulty: RoadmapDifficulty.beginner,
            estimatedMinutes: 45,
            priority: RoadmapItemPriority.critical,
            ...
            hintId: 'java_lang',
            recommendationReason:
                'Core language foundation for software engineering practices.',
            completed: completed,
          ),
          _createItem(
            id: 'se_p1_dsa',
            ...
            description:
                'Trees, graphs, dynamic programming, sorting, and binary search.',
            category: 'DSA',
            difficulty: RoadmapDifficulty.intermediate,
            estimatedMinutes: 45,
            priority: RoadmapItemPriority.critical,
            ...
            hintId: 'dsa_arrays',
            recommendationReason:
                'Crucial for passing coding interviews and writing efficient software.',
            completed: completed,
          ),
        ],
      ),
      RoadmapPhase(
        ...
        description:
            'Relational databases, indexing, transactions, and REST APIs.',
        sequence: 2,
        estimatedDuration: '4–5 weeks',
        items: [
          _createItem(
            ...
            description:
                'Normalization, joins, indexing, query execution, and transactions.',
            category: 'Databases',
            difficulty: RoadmapDifficulty.intermediate,
            estimatedMinutes: 45,
            priority: RoadmapItemPriority.high,
            ...
            hintId: 'db_sql',
            recommendationReason:
                'Essential database persistence and query optimization skills.',
            completed: completed,
          ),
        ],
      ),
      RoadmapPhase(
        ...
        description:
            'Construct a multi-tier software system and prepare technical credentials.',
        sequence: 3,
        estimatedDuration: '4 weeks',
        items: [
          _createItem(
            ...
            description:
                'Build a production-grade software utility with unit tests, CI/CD, and docs.',
            category: 'Project',
            difficulty: RoadmapDifficulty.advanced,
            estimatedMinutes: 90,
            priority: RoadmapItemPriority.critical,
            ...
            hintId: 'portfolio_website_proj',
            recommendationReason:
                'Tangible portfolio project showcasing software development capabilities.',
            completed: completed,
          ),
        ],
      ),
  ...
  RoadmapItem _createItem({
    ...
    final isAlreadyDone =
        completed[id] == true || completed[targetSkill.toLowerCase()] == true;
    final status = isAlreadyDone
        ? RoadmapItemStatus.completed
        : RoadmapItemStatus.notStarted;

    // Ground against real UniDocs resources
    final resolved = RoadmapResourceResolver.resolve(targetSkill,
        category: category, hintId: hintId);
    ...
    return RoadmapItem(
      ...
      resourceReference:
          resolved.isAvailable ? resolved.resourceReference : null,
