...
class PdfRepository {
  ...
  List<ResourceModel> filterDocuments(
    ...
    return allResources.where((doc) {
      if (yearId != null && yearId.isNotEmpty && doc.yearId != yearId) return false;
      if (semesterId != null && semesterId.isNotEmpty && doc.semesterId != semesterId) return false;
      if (subjectId != null && subjectId.isNotEmpty && doc.subjectId != subjectId) return false;
      if (unitId != null && unitId.isNotEmpty && doc.unitId != unitId) return false;
      if (topicId != null && topicId.isNotEmpty && doc.topicId != topicId) return false;
      if (documentType != null && documentType.isNotEmpty && doc.documentType != documentType) return false;
      if (difficultyLevel != null && difficultyLevel.isNotEmpty && doc.difficultyLevel != difficultyLevel) return false;
      return true;
    }).toList();
  }
  ...
  List<String> validateDocumentUrls(List<ResourceModel> resources) {
    ...
    for (final res in resources) {
      ...
      } else if (!res.storageUrl.startsWith('https://') && !res.storageUrl.startsWith('http://')) {
        errors.add('Invalid URL scheme (must be HTTPS/HTTP) for Resource ID: ${res.id} (${res.storageUrl})');
      }
  ...
  static List<ResourceModel> get sampleAcademicPdfCatalog => [
        ...
        ResourceModel(
          ...
          description: 'Comprehensive beginner lecture notes introducing C compilers, variables, printf/scanf syntax, and conditional loops.',
          ...
          storageUrl: 'https://cdn.csse-study-hub.org/academic/year_1/sem_1_1/c_prog/unit_1_c_syntax.pdf',
          ...
          whyUseIt: 'Essential reading for 1st-year students before writing C code in laboratory sessions.',
        ...
        ResourceModel(
          ...
          description: 'Previous year university examination questions with step-by-step solved C programs and answer keys.',
          subjectId: 'subj_1_1_4',
          subjectName: 'Computer Programming Using C',
          yearId: 'year_1',
          semesterId: 'sem_1_1',
          ...
          storageUrl: 'https://cdn.csse-study-hub.org/academic/year_1/sem_1_1/c_prog/c_prog_pyq_bank.pdf',
        ...
        ResourceModel(
          ...
          description: 'Detailed structural notes on pointer memory allocation, linked list node insertion, deletion, and LRU cache.',
          ...
          storageUrl: 'https://cdn.csse-study-hub.org/academic/year_2/sem_2_1/ds/unit2_linked_lists.pdf',
          ...
          whyUseIt: 'Crucial for 2nd-year CSE students preparing for data structure lab exams and coding interviews.',
        ...
        ResourceModel(
          ...
          storageUrl: 'https://cdn.csse-study-hub.org/academic/year_2/sem_2_1/os/os_concepts_galvin.pdf',
        ...
        ResourceModel(
          ...
          storageUrl: 'https://cdn.csse-study-hub.org/academic/year_3/sem_3_1/cn/cn_lab_manual.pdf',
        ...
        ResourceModel(
          ...
          storageUrl: 'https://cdn.csse-study-hub.org/academic/year_1/sem_1_1/c_prog/unit_4_file_io.pdf',
          fileSizeBytes: 0,
          pageCount: 0,
