...
class PlacementRepository {
  ...
  static const List<PlacementModel> _fallbackPlacementResources = [
    ...
    PlacementModel(
      ...
      description: 'Complete beginner-first placement roadmap for CSE students: understand campus recruitment rounds, CGPA benchmarks, eligibility criteria, online assessments (OA), and 4-year preparation timeline.',
      roadmap: 'Year 1: Core Programming & Math → Year 2: DSA & CS Fundamentals → Year 3: Projects, Resume & OA Practice → Year 4: Company Prep & Mock Interviews.',
      tips: [
      ...
      questionsAndAnswers: [
        PlacementQuestionAnswer(
          category: 'Roadmap',
          question: 'What is the standard campus placement selection process for CSE students?',
          answer: 'The typical process consists of 4 stages: 1. Resume Shortlisting & CGPA Cutoff -> 2. Online Assessment (Aptitude, Reasoning, Verbal & 2 Coding Problems) -> 3. Technical Interview Rounds (DSA, CS Fundamentals, Projects) -> 4. HR / Management Interview.',
          keyPoints: ['First round filter is OA + CGPA', 'Technical round evaluates DSA problem-solving & CS fundamentals', 'HR round evaluates communication & company culture fit'],
        ),
        PlacementQuestionAnswer(
          category: 'Roadmap',
          question: 'What should a first-year CSE student focus on for placements?',
          answer: '1st Year Focus: 1. Master one programming language deeply (C++ / Java / Python), 2. Practice basic quantitative math & logical reasoning 30 mins daily, 3. Maintain CGPA above 8.0, 4. Build strong English & communication skills.',
          keyPoints: ['Master language fundamentals first', 'Do not stress over advanced system design in 1st year'],
        ),
      ],
    ),
    ...
    PlacementModel(
      ...
      description: 'Master core mathematical concepts, shortcut formulas, percentages, ratios, time & work, and speed distance required for company online assessment tests.',
      roadmap: 'Phase 1: Basic Fractions & Ratios → Phase 2: Percentages & Profit/Loss → Phase 3: Work Rates & Pipe Problems → Phase 4: Speed, Distance & Timed Practice.',
      tips: [
      ...
      questionsAndAnswers: [
        ...
        PlacementQuestionAnswer(
          ...
          answer: 'Reduction % = [R / (100 + R)] × 100 = [25 / 125] × 100 = 20%.',
          keyPoints: ['Use standard percentage formula: R / (100 + R) * 100 for price increase', '25% increase requires 20% consumption reduction'],
        ),
      ],
    ),
    ...
    PlacementModel(
      ...
      description: 'Master circular & linear seating arrangements, blood relations, syllogisms, number/letter series, coding-decoding, and chart interpretation.',
      roadmap: 'Phase 1: Series & Coding-Decoding → Phase 2: Blood Relations & Directions → Phase 3: Syllogism Venn Diagrams → Phase 4: Seating Arrangements & Puzzles.',
      tips: [
      ...
      questionsAndAnswers: [
        ...
        PlacementQuestionAnswer(
          ...
          answer: 'His son\'s photograph. "My father\'s son" = Himself (since he has no siblings). So "that man\'s father is myself" -> The photograph is of his son.',
          keyPoints: ['Break down statement backward', '"My father\'s son" with no siblings = Me'],
        ),
      ],
    ),
    ...
    PlacementModel(
      ...
      description: 'Master English grammar rules, spotting errors, sentence correction, reading comprehension strategies, vocabulary building, and interview communication.',
      roadmap: 'Phase 1: Grammar Rules & Subject-Verb Agreement → Phase 2: Vocabulary & Synonym/Antonym Practice → Phase 3: Reading Comprehension Techniques → Phase 4: Professional Self Introduction.',
      tips: [
      ...
      questionsAndAnswers: [
        PlacementQuestionAnswer(
          category: 'Verbal Ability',
          question: 'Spot the error: "Each of the students have submitted their assignment."',
          answer: 'Error: "have". Correct sentence: "Each of the students HAS submitted his/her assignment." Reason: "Each" is a singular indefinite pronoun requiring a singular verb ("has").',
          keyPoints: ['Indefinite pronouns (each, every, someone) take singular verbs', 'Do not get confused by plural noun "students" inside prepositional phrase'],
        ),
      ],
    ),
    ...
    PlacementModel(
      ...
      description: 'High-frequency technical interview questions on Operating Systems, Database Management Systems, SQL queries, Computer Networks, and OOP.',
    ...
    PlacementModel(
      ...
      description: 'High-frequency coding interview patterns: Two Pointers, Sliding Window, Fast & Slow Pointers, Linked Lists, Binary Trees, Graphs, Dynamic Programming, and time/space complexity trade-offs.',
      roadmap: 'Phase 1: Arrays & Two Pointers → Phase 2: Sliding Window & Fast/Slow Pointers → Phase 3: Trees & Graphs → Phase 4: Dynamic Programming & Top 150 LeetCode.',
      tips: [
      ...
      questionsAndAnswers: [
        PlacementQuestionAnswer(
          category: 'Coding',
          question: 'How do you solve the Two Sum problem in O(N) time complexity?',
          answer: 'Use a Hash Map storing value -> index. Iterate through the array once: for element X, check if (Target - X) exists in the Hash Map. If found, return [map[Target - X], current_index]. If not, insert X -> current_index into map.',
          keyPoints: ['Brute force is O(N^2) using nested loops', 'Hash map reduces lookup to O(1), achieving overall O(N) time and O(N) space'],
        ),
      ],
    ),
    ...
    PlacementModel(
      ...
      description: 'Structure behavioral interview responses using the STAR method (Situation, Task, Action, Result) to impress HR interviewers for Tell me about yourself, Strengths/Weaknesses, and Career Goals.',
    ...
    PlacementModel(
      ...
      description: 'Format an ATS-optimized one-page engineering resume (Jake\'s LaTeX template) and build an active LinkedIn professional profile.',
    ...
    PlacementModel(
      ...
      description: 'Learn how to research target tech companies, analyze job descriptions, identify required skills, review interview rounds, and follow a pre-interview application checklist.',
      roadmap: 'Phase 1: Job Description & Skill Gap Analysis → Phase 2: Company Products & Tech Stack Research → Phase 3: Review Past Interview Experiences → Phase 4: Final Day Checklist.',
      tips: [
      ...
      questionsAndAnswers: [
        PlacementQuestionAnswer(
          ...
          question: 'How should a student prepare for a specific company\'s campus placement drive?',
          answer: '1. Research the company\'s core products and tech stack. 2. Solve past company interview questions on GeeksforGeeks Company Corner. 3. Review core CS subjects relevant to their tech stack (e.g., DBMS & SQL for backend roles). 4. Prepare customized questions for the interviewer.',
          keyPoints: ['Solve past 3 years company specific coding & aptitude questions', 'Customize your resume highlights according to the job role'],
        ),
      ],
    ),
  ];
