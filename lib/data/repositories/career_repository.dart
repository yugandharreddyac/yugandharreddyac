...
class CareerRepository {
  ...
  static List<CareerModel> get fallbackCareerTechnologies =>
      _fallbackCareerTechnologies;
  ...
  static const List<CareerModel> _fallbackCareerTechnologies = [
    ...
    CareerModel(
      ...
      introduction:
          'Design, train, and deploy deep learning neural networks, computer vision algorithms, and natural language models.',
      whyLearn:
          'Core cognitive engineering role powering autonomous systems, medical imaging, and enterprise automation.',
      careerOpportunities: [
      ...
      learningPhases: [
        LearningPhaseModel(
          ...
          description:
              'Master matrix operations, partial derivatives, and tensor manipulations in PyTorch.',
        ...
        LearningPhaseModel(
          ...
          description:
              'Train deep convolutional networks and self-attention mechanisms for vision and text.',
          estimatedDuration: '6 Weeks',
          topics: ['CNNs', 'ResNets', 'Object Detection', 'Transformers'],
          milestones: [
            'Classify CIFAR-10 images at 90%+ accuracy',
      ...
      skillMatrix: [
        SkillMatrixModel(
          ...
          description:
              'Deep neural network design, CUDA tensor acceleration, and model autograd.',
        ),
        SkillMatrixModel(
          ...
          description:
              'Image filtering, bounding box regressions, and YOLO object tracking.',
        ),
      ],
      ...
      miniProjects: [
        CareerProjectInfo(
            ...
            description: 'Build CNN using PyTorch',
            difficulty: 'Beginner'),
      ],
      advancedProjects: [
        CareerProjectInfo(
            title: 'Real-Time Edge Object Detector',
            description: 'YOLOv8 Streamlit application',
            difficulty: 'Advanced'),
      ],
      githubRepos: [
        CareerResourceLink(
      ...
      futureScope:
          'Rapid growth driven by autonomous robotics, generative AI, and edge AI hardware.',
    ),
    ...
    CareerModel(
      ...
      introduction:
          'Architect applications powered by Large Language Models, Retrieval-Augmented Generation (RAG), and autonomous AI agents.',
      whyLearn:
          'Fastest-growing engineering specialization transforming enterprise software, search, and productivity.',
      careerOpportunities: [
        'GenAI Engineer',
      ...
      certifications: [
        CareerResourceLink(
            title: 'LangChain Developer Certification',
            url: 'https://langchain.com',
            platform: 'LangChain'),
      ],
      youtubePlaylists: [
        CareerResourceLink(
            title: 'Andrej Karpathy - Let us build GPT',
            url: 'https://youtube.com',
            platform: 'YouTube'),
      ],
      miniProjects: [
        CareerProjectInfo(
            title: 'PDF Document Q&A Bot',
            description: 'RAG system using LangChain & ChromaDB',
            difficulty: 'Intermediate'),
      ],
      advancedProjects: [
        CareerProjectInfo(
            title: 'Multi-Agent Autonomous Coding Assistant',
            description: 'CrewAI agent swarm writing code',
            difficulty: 'Advanced'),
      ],
      githubRepos: [
        CareerResourceLink(
            title: 'LangChain GitHub Repo',
            url: 'https://github.com/langchain-ai/langchain',
            platform: 'GitHub'),
      ],
      futureScope:
          'Critical infrastructure layer for next-generation AI-native software applications.',
    ),
    ...
    CareerModel(
      ...
      icon: 'web_rounded',
      introduction:
          'Build modern responsive frontends and resilient backend REST/GraphQL microservices.',
      whyLearn:
          'Foundational engineering role across global tech companies, high-growth startups, and freelancing.',
      careerOpportunities: [
        'Full Stack Engineer',
        'Frontend Engineer',
        'Backend Developer',
      ...
      miniProjects: [
        CareerProjectInfo(
            ...
            description: 'React & Node.js Kanban app',
            difficulty: 'Beginner'),
      ],
      advancedProjects: [
        CareerProjectInfo(
            title: 'E-Commerce Platform with Stripe Checkout',
            description: 'Full stack microservices store',
            difficulty: 'Advanced'),
      ],
      githubRepos: [
        CareerResourceLink(
      ...
      futureScope:
          'Constant demand as business digital transformation expands globally.',
    ),
    ...
    CareerModel(
      ...
      icon: 'dns_rounded',
      introduction:
          'Design high-throughput backend APIs, distributed databases, event-driven messaging, and server infrastructure.',
      whyLearn:
          'Core discipline ensuring scalable software performance, data integrity, and system reliability.',
      careerOpportunities: [
        'Backend Engineer',
        'Systems Architect',
      ...
      youtubePlaylists: [
        CareerResourceLink(
            title: 'Hussein Nasser Database & Systems',
            url: 'https://youtube.com',
            platform: 'YouTube'),
      ],
      miniProjects: [
        CareerProjectInfo(
            title: 'Base62 URL Shortener Microservice',
            description: 'Fast Node.js / Go shortener',
            difficulty: 'Beginner'),
      ],
      advancedProjects: [
        CareerProjectInfo(
            title: 'Distributed Multi-Tenant Payment Processor',
            description: 'Go + Kafka idempotency engine',
      ...
      futureScope:
          'High compensation and long-term career growth in cloud enterprise engineering.',
    ),
    ...
    CareerModel(
      ...
      icon: 'cloud_rounded',
      introduction:
          'Automate infrastructure provisioning, CI/CD deployment pipelines, container orchestration, and cloud monitoring.',
      whyLearn:
          'Essential engineering function bridging software development and IT cloud infrastructure.',
      careerOpportunities: [
        'DevOps Engineer',
        'Cloud Architect',
      ...
      advancedProjects: [
        CareerProjectInfo(
            title: 'Multi-Region Kubernetes Cluster with Terraform',
            description: 'Production AWS EKS Setup',
            difficulty: 'Advanced'),
      ],
      githubRepos: [
        CareerResourceLink(
      ...
      futureScope:
          'Indispensable role as enterprise software moves 100% to cloud infrastructure.',
    ),
    ...
    CareerModel(
      ...
      introduction:
          'Protect networks, web applications, and cloud environments against cyber threats, vulnerabilities, and unauthorized intrusions.',
      whyLearn:
          'Critical global defense discipline protecting user data, finance systems, and infrastructure.',
      careerOpportunities: [
        'Ethical Hacker',
        'Penetration Tester',
      ...
      certifications: [
        CareerResourceLink(
            title: 'CompTIA Security+ / CEH',
            url: 'https://comptia.org',
            platform: 'CompTIA'),
      ],
      youtubePlaylists: [
        CareerResourceLink(
            title: 'NetworkChuck Security Lessons',
            url: 'https://youtube.com',
            platform: 'YouTube'),
      ],
      miniProjects: [
        CareerProjectInfo(
            ...
            description: 'Python socket security tool',
            difficulty: 'Beginner'),
      ],
      advancedProjects: [
        CareerProjectInfo(
            title: 'Automated Web Vulnerability Scanner',
            description: 'OWASP Top 10 auditing tool',
            difficulty: 'Advanced'),
      ],
      githubRepos: [
        CareerResourceLink(
      ...
      futureScope:
          'High demand driven by increasing cloud data security regulations and threat landscape.',
    ),
    ...
    CareerModel(
      ...
      introduction:
          'Build high-performance, beautiful mobile and web applications using Dart, Flutter, and Clean Architecture.',
      whyLearn:
          'Single codebase powering native iOS, Android, and Web applications used by millions.',
      careerOpportunities: [
        'Flutter Developer',
      ...
      miniProjects: [
        CareerProjectInfo(
            ...
            description: 'Offline Flutter + SQLite app',
            difficulty: 'Beginner'),
      ],
      advancedProjects: [
        CareerProjectInfo(
            title: 'UniDocs Academic & Career Platform',
            description: 'Production Clean Architecture app',
            difficulty: 'Industry Level'),
      ],
      githubRepos: [
        CareerResourceLink(
            title: 'Flutter Samples Repo',
            url: 'https://github.com/flutter/samples',
            platform: 'GitHub'),
      ],
      futureScope:
          'Dominant cross-platform framework choice for modern mobile startups and corporate apps.',
    ),
    ...
    CareerModel(
      ...
      introduction:
          'Develop native high-performance Android applications using Kotlin, Jetpack Compose, Coroutines, and Dagger Hilt.',
      whyLearn:
          'Core OS engineering role driving 3+ billion Android devices worldwide.',
      careerOpportunities: [
      ...
      bestFreeResources: [
        CareerResourceLink(
            title: 'Android Developers Training',
      ...
      books: [
        CareerResourceLink(
            ...
            url: 'https://bignerdbranch.com',
            platform: 'BigNerdRanch'),
      ],
      certifications: [
        CareerResourceLink(
      ...
      youtubePlaylists: [
        CareerResourceLink(
            title: 'Philipp Lackner Android Tutorials',
            url: 'https://youtube.com',
            platform: 'YouTube'),
      ],
      miniProjects: [
        CareerProjectInfo(
            ...
            description: 'Jetpack Compose + OpenWeather API',
            difficulty: 'Beginner'),
      ],
      advancedProjects: [
        CareerProjectInfo(
            title: 'Offline Video & Audio Streaming Player',
            description: 'Media3 Exoplayer + Room DB app',
            difficulty: 'Advanced'),
      ],
      githubRepos: [
        CareerResourceLink(
      ...
      futureScope:
          'Enduring demand across mobile hardware, smart TVs, automotive (Android Auto), and wearables.',
    ),
  ];
}
