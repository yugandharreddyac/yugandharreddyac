...
class CodingResourceModel {
  final String id;
  final String title;
  final String platform; // LeetCode, HackerRank, CodeChef, Codeforces, GeeksforGeeks, SQL Practice, DSA Roadmap, Coding Sheets
  final String category;
  final String difficulty; // Easy, Medium, Hard, All Levels
  final String url;
  final String description;
  final String sheetName; // e.g., Striver SDE Sheet, Love Babbar 450, NeetCode 150
